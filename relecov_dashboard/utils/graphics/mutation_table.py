...
# ---- Set up ----
# Input
input_file = '/home/usuario/Proyectos/relecov/relecov-platform/data/variants_long_table.csv'
sample_id = "214821"
...
@app.callback(Output('mutation_table-message', 'children'), Input('mutation_table', 'active_cell'))
